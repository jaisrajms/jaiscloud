...
export default function App() {
    ...
    return (_jsx(Layout, { children: _jsxs(Routes, { children: [_jsx(Route, { path: "/", element: _jsx(Navigate, { to: "/aws/sqs", replace: true }) }), _jsx(Route, { path: "/aws/sqs/*", element: _jsx(SQSRoutes, {}) }), _jsx(Route, { path: "/aws/lambda/*", element: _jsx(LambdaRoutes, {}) }), _jsx(Route, { path: "/aws/logs/*", element: _jsx(LogsRoutes, {}) }), _jsx(Route, { path: "*", element: _jsx(Navigate, { to: "/", replace: true }) })] }) }));
}
